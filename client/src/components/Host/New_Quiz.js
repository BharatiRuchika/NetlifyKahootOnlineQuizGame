...
class New_Quiz extends Component {
    ...
    async createQuiz(){
        ...
        var res = await axios.post('https://online-kahoot-multiplayer-quiz-game.vercel.app/quiz/addQuiz', {quizName: this.state.quiz_name, quizDescription: this.state.info,userId
        },{
            headers:{
                'auth-token':token
            }
